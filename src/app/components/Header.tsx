...
export default function Header() {
    return (
        <div className="navbar h-20 bg-white-main hover:bg-white-light sticky top-0 z-50 hover:shadow-sm duration-1000">
            <div className="flex items-center justify-center w-full">
                <div className="flex items-center justify-start sm:justify-center w-1/2 gap-4">
                    ...
                    <p className={`text-[50px] text-black ${logoFont.className} select-none`}>
                        Jiki
                    </p>
                </div>
